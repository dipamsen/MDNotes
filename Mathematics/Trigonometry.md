...
5. $\displaystyle\tan (a+b) = \frac{\tan a + \tan b}{1-\tan a \tan b}$

5. $\displaystyle\tan (a-b) = \frac{\tan a - \tan b}{1+\tan a \tan b}$
6. $\displaystyle\cot (a+b) = \frac{\cot a\cot b -1}{\cot b + \cot a}$
6. $\displaystyle\cot (a-b) = \frac{\cot a\cot b +1}{\cot b - \cot a}$
* **Multiples of $\frac\pi2$***
12. $\displaystyle\sin \left(\frac\pi2-x\right) = \cos x$

7. $\displaystyle\sin \left(\frac\pi2+x\right) = -\cos x$
7. $\displaystyle\sin (\pi-x) = \sin x$
7. $\displaystyle\sin (\pi+x) = -\sin x$
7. $\displaystyle\sin (2\pi-x) = -\sin x$
8. $\displaystyle\cos \left(\frac\pi2-x\right) = \sin x$
8. $\displaystyle\cos \left(\frac\pi2+x\right) = \sin x$
8. $\displaystyle\cos (\pi-x) = -\cos x$
8. $\displaystyle\cos (\pi+x) = -\cos x$
8. $\displaystyle\cos (2\pi-x) = \cos x$
* **Double Angle**
22. $\sin 2x=2\sin x\cos x$
10. $\begin{aligned}[t]\cos 2x &=2\cos^2 x - 1 \\ &= 1 - 2\sin^2 x\\ &= \cos^2 x-\sin^2 x\end{aligned}$

11. $\displaystyle\tan 2x=\frac{2\tan x}{1+\tan^2x}$
* **Triple Angle**
25. $\sin 3x=3\sin x - 4\sin^3 x$
25. $\cos 3x=4\cos^3 x - 3\cos x$

25. $\displaystyle\tan 3x=\frac{3\tan x - \tan^3 x}{1-3\tan^2 x}$
* **Sum/Difference of Sines and Cosines**
28. $\displaystyle\cos a + \cos b=2\cos \left(\frac{a+b}2\right)\cos\left(\frac{a-b}2\right)$

28. $\displaystyle\cos a - \cos b=-2\sin \left(\frac{a+b}2\right)\sin\left(\frac{a-b}2\right)$
28. $\displaystyle\sin a + \sin b=2\sin \left(\frac{a+b}2\right)\cos\left(\frac{a-b}2\right)$
28. $\displaystyle\sin a - \sin b=2\cos \left(\frac{a+b}2\right)\sin\left(\frac{a-b}2\right)$
* **Product of Sines and Cosines (Inverse of 28-31)**
32. $2\cos a\cos b = \cos (a+b)+\cos(a-b)$
32. $-2\sin a\sin b = \cos (a+b)-\cos(a-b)$
32. $2\sin a\cos b = \sin (a+b)+\sin(a-b)$

32. $2\cos a\sin b = \sin (a+b)-\sin(a-b)$
* **Zero Values***
36. $\sin x = 0 \implies x=n\pi, n\in Z$

36. $\displaystyle\cos x = 0 \implies x=(2n+1)\frac\pi2, n\in Z$
* **Equal Values***
38. $\sin x = \sin y \implies x = n\pi + (-1)^ny$
36. $\cos x = \cos y \implies x = 2n\pi \pm y$
36. $\tan x = \tan y \implies x = n\pi  + y$
